  ...
  >
    <form method="POST" action="?/deploy">
      <div class="-mx-3 mb-2">
        ...
        <button
          type="submit"
          class="bg-green-500 hover:bg-green-700 text-white font-bold mt-5 ml-2 px-2 py-2 rounded"
        >
          Deploy bounty
        </button>
      </div>
  ...
  >
    <form method="POST" action="?/unlock">
      <div class="-mx-3 mb-2">
        ...
        <button
          type="submit"
          class="bg-red-500 hover:bg-red-700 text-white font-bold mt-5 ml-2 px-2 py-2 rounded"
        >
          Unlock bounty
        </button>
      </div>
