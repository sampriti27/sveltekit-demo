...
export const actions = {
  login: async ({ request }) => {
    ...
    // const signUpResponse = await authModule.signUp({ email: "sampriti.mukherjee2023@gmail.com", password: "string" });
  ...
  pay: async ({ request }) => {
    ...
    return { transaction: true, payment: payResponse.data.txid };
  },
};
